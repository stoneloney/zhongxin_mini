...
exports.OrderStatusStr = OrderStatusStr;
...
function orderDetail(data, callback) {
  var apiUrl = "/order/detail";
  return (0, _http.PostReq)(apiUrl, data, callback);
}
function payOrderUse(data, callback) {
  var apiUrl = "/order/use";
  return (0, _http.PostReq)(apiUrl, data, callback);
}
function cancelOrder(data, callback) {
  var apiUrl = "/order/cancel";
  return (0, _http.PostReq)(apiUrl, data, callback);
}
...
function addressOperate(data, callback) {
  var apiUrl = "/address/operate";
  return (0, _http.PostReq)(apiUrl, data, callback);
}
...
function ArticleDetail(id, callback) {
  var apiUrl = "/article/detail";
  return (0, _http.PostReq)(apiUrl, {
    id: id
  }, callback);
}
...
exports.MemberInfoUpdate = MemberInfoUpdate;
exports.MemberPassengerCreate = MemberPassengerCreate;
exports.MemberPassengerDelete = MemberPassengerDelete;
exports.MemberPassengerInfo = MemberPassengerInfo;
exports.MemberPassengerList = MemberPassengerList;
...
function MemberInfoUpdate(data, callback) {
  var apiUrl = "/member/update";
  return (0, _http.PostReq)(apiUrl, data, callback);
}

// 用户票务预定信息
function MemberTicketReserve(data, callback) {
  var apiUrl = "/member/ticket/reserve";
  return (0, _http.PostReq)(apiUrl, data, callback);
}

// 乘机人添加
function MemberPassengerCreate(data, callback) {
  var apiUrl = "/member/passenger/create";
  return (0, _http.PostReq)(apiUrl, data, callback);
}

// 乘机人修改
function MemberPassengerUpdate(data, callback) {
  var apiUrl = "/member/passenger/update";
  return (0, _http.PostReq)(apiUrl, data, callback);
}

// 乘机人信息删除
function MemberPassengerDelete(data, callback) {
  var apiUrl = "/member/passenger/del";
  return (0, _http.PostReq)(apiUrl, data, callback);
}

// 乘机人信息
function MemberPassengerInfo(data, callback) {
  var apiUrl = "/member/passenger/info";
  return (0, _http.PostReq)(apiUrl, data, callback);
}

// 乘机人列表
function MemberPassengerList(data, callback) {
  var apiUrl = "/member/passenger/list";
  return (0, _http.PostReq)(apiUrl, data, callback);
}

// 获取用户资料
function MemberDetail(data, callback) {
  var apiUrl = "/member/detail";
  return (0, _http.PostReq)(apiUrl, data, callback);
}
...
// 获取用户信息
function MemberInfo() {
  var info = uni.getStorageSync('memberInfo');
  return info;
}
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 2)["default"]))
